...
public class KafkaTestContainer extends ConfluentKafkaContainer {
    ...
    public static void setDynamicProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.kafka.consumer.properties.group.instance.id", () -> "consumer-main");
        registry.add("spring.kafka.producer.properties.group.instance.id", () -> "producer-main");
