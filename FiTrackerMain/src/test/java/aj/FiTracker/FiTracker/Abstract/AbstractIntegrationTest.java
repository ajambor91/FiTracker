...
@Testcontainers
public class AbstractIntegrationTest extends PostgreSQLContainer<AbstractIntegrationTest> {
    @Container
    protected static AbstractIntegrationTest container = new AbstractIntegrationTest()
